...
class mx::OpenGL : public mx::GraphicsLibrary
{
public:
	...
	static void					checkForGLError(std::string strMarkerText);
...
private:
	...
	uint32						addBufferRaw(uint32 uiShaderAttributeLocation, const char *pBufferData, uint32 uiBufferByteCount, uint32 uiComponentCount);
};